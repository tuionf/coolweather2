package com.example.tuionf.coolweather;
...
import com.example.tuionf.coolweather.gson.Forecast;
import com.example.tuionf.coolweather.gson.Weather;
import com.example.tuionf.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        for (Forecast forecast:weather.forecastList
            ...
            View view = LayoutInflater.from(this).inflate(R.layout.forecast_item,forcastLayout,
                    false);
